...
const GalleryCard = () => {
  ...
  return (
    <div className="p-4 relative">
      <h1 className="text-center text-3xl font-semibold text-[#111111]">
        Gallery
      </h1>
      ...
      <div className="flex items-center justify-center">
        <button
          ...
          className="bg-[#0B4D81] text-[#FFFFFF] px-3 py-2"
        >
          See more
        </button>
      </div>
      ...
      {isModalOpen && (
        ...
        >
          <div className="relative max-w-4xl w-full p-4">
            ...
            />
            <button
              className="absolute top-4 right-4 text-white bg-[#bb2821]  px-7 py-3 hover:bg-opacity-70 transition text-3xl"
              onClick={closeModal}
            >
              <p className=" border-4  border-white w-10 h-10 rounded-full flex items-center justify-center font-semibold">
                &times;
              </p>
            </button>
          </div>
