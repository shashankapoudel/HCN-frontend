...
//     const filteredProducts = products.filter((p) => p.category === 'singing-bowls')
...
//             <div className=''>
//                 <h1 className='text-[#111111] text-center font-edensor text-lg'>Singing Bowls</h1>
//                 <p className='text-[#606060] text-sm md:text-base text-center'>We offer variety of Tibetan and Nepali Singing Bowls</p>
//             </div>
