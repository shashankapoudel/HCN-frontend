  ...
  return (
    <div className="w-full bg-[#F7F7F7]">
      <div className="w-full bg-[#FFFFFF] p-4">
        <h2 className="text-xl font-semibold text-[#00B0A7]">
          ...
          <div className="mt-5 gap-4 flex flex-col justify-between items-start p-2 w-full">
              ...
              {navItems.map((item) => (
                <div key={item.name} className="relative">
                  ...
                  >
                    ...
                    {item.subItems && (
                      <FiChevronDown className="text-gray-600 mt-1" />
                    )}
                  </button>
            ...
            <div className="w-full p-2">
              <button
                ...
                className="text-start flex  items-center bg-[#CE2D000D] gap-2 w-full py-3 px-2 text-[#CE2D00]"
              >
                <CiLogout />
                Logout
              </button>
