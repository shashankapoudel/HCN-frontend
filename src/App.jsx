...
//   const IS_UNDER_CONSTRUCTION = import.meta.env.VITE_MAINTENANCE === "true";
...
//   return (
//     <div className="flex flex-col font-poppins min-h-screen">
//       {!isAdminRoute && !IS_UNDER_CONSTRUCTION && <Header />}

//       <div className={`flex-grow ${!isAdminRoute ? "pt-36 lg:pt-40" : "pt-0"}`}>
//         <Routes>
//           {IS_UNDER_CONSTRUCTION && !isAdminRoute ? (
...
//       {!isAdminRoute && !IS_UNDER_CONSTRUCTION && <Footer />}
//     </div>
//   );
// }
