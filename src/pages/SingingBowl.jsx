  ...
  return (
    <div className="min-h-screen p-3 lg:p-8">
      <div className="px-2 lg:px-6">
        ...
        <p className="text-none lg:text-center text-[#606060] text-justify font-edensor text-lg tracking-wide">
          The singing bowl comes from the Himalayan regions of Nepal and Tibet
          and has been used for many years.It is usually round in shape and made
          from metal using traditional hand-hammering methods.Singing bowls come
          in different sizes, from small ones that fit in your hand to large
          ones placed on the floor.In the past, they were used in meditation,
          prayer, and healing practices. Today, they are used for yoga, sound
          therapy, relaxation, and stress relief in modern wellness practices.We
          produce singing bowls in our own factory, where skilled artisans work
      ...
      <div className="p-2 md:p-4 lg:p-8 mt-3">
        ...
        <div className="mt-3">
          <h2 className="text-2xl font-bold mb-0 lg:mb-2 text-center">
